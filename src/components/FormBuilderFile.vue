  ...
  <div>
    ...
    <label :for="inputUid">
      <q-img
        ...
        :class="customClass"
      />
      <q-icon v-if="previewMode === 'audio'" size="2rem" name="audiotrack" :class="customClass"/>
      <q-icon v-if="previewMode === 'pdf'" size="100px" name="picture_as_pdf" :class="customClass"/>
      <q-icon
...
export default {
    ...
    watch: {
        value(newValue) {
            ...
            console.log(this.getSourceExtension())
